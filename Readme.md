# Table of Contents
1. [Smoke Simulation: Experiments in Generating and Augmenting Smoke](#smoke-simulation-experiments-in-generating-and-augmenting-smoke)
2. [Disclaimer](#disclaimer)
3. [Why am I doing this?](#why-am-i-doing-this)
4. [Use Cases](#use-cases)
   - [Smoke Overlaying](#smoke-overlaying)
   - [Smoke Segmentation](#smoke-segmentation)
...
7. [Using this for Image Augmentation](#using-this-for-image-augmentation)
   - [Example](#example)
   - [Preview](#preview-2)
8. [Using this With Video](#using-this-with-video)
9. [To do](#to-do)
10. [Collaborating](#collaborating)
